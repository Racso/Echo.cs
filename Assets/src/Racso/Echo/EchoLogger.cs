...
namespace Racso.Echo
{
    public class EchoLogger
    {
        ...
        internal EchoLogger(LoggerCore loggerCore)
        {
        ...
        public void Debug(string system, string message)
            => loggerCore.WriteIfEnabled(LogLevel.Debug, false, system, message);

        public void Debug<T1>(string system, string format, T1 param1)
            => loggerCore.WriteIfEnabled(LogLevel.Debug, false, system, format, param1);

        public void Debug<T1, T2>(string system, string format, T1 param1, T2 param2)
            => loggerCore.WriteIfEnabled(LogLevel.Debug, false, system, format, param1, param2);

        public void Debug<T1, T2, T3>(string system, string format, T1 param1, T2 param2, T3 param3)
            => loggerCore.WriteIfEnabled(LogLevel.Debug, false, system, format, param1, param2, param3);

        public void Debug<T1, T2, T3, T4>(string system, string format, T1 param1, T2 param2, T3 param3, T4 param4)
            => loggerCore.WriteIfEnabled(LogLevel.Debug, false, system, format, param1, param2, param3, param4);

        public void Debug1(string system, string message)
            => loggerCore.WriteIfEnabled(LogLevel.Debug, true, system, message);

        public void Debug1<T1>(string system, string format, T1 param1)
            => loggerCore.WriteIfEnabled(LogLevel.Debug, true, system, format, param1);

        public void Debug1<T1, T2>(string system, string format, T1 param1, T2 param2)
            => loggerCore.WriteIfEnabled(LogLevel.Debug, true, system, format, param1, param2);

        public void Debug1<T1, T2, T3>(string system, string format, T1 param1, T2 param2, T3 param3)
            => loggerCore.WriteIfEnabled(LogLevel.Debug, true, system, format, param1, param2, param3);

        public void Debug1<T1, T2, T3, T4>(string system, string format, T1 param1, T2 param2, T3 param3, T4 param4)
            => loggerCore.WriteIfEnabled(LogLevel.Debug, true, system, format, param1, param2, param3, param4);
        ...
        public void Info(string system, string message)
            => loggerCore.WriteIfEnabled(LogLevel.Info, false, system, message);

        public void Info<T1>(string system, string format, T1 param1)
            => loggerCore.WriteIfEnabled(LogLevel.Info, false, system, format, param1);

        public void Info<T1, T2>(string system, string format, T1 param1, T2 param2)
            => loggerCore.WriteIfEnabled(LogLevel.Info, false, system, format, param1, param2);

        public void Info<T1, T2, T3>(string system, string format, T1 param1, T2 param2, T3 param3)
            => loggerCore.WriteIfEnabled(LogLevel.Info, false, system, format, param1, param2, param3);

        public void Info<T1, T2, T3, T4>(string system, string format, T1 param1, T2 param2, T3 param3, T4 param4)
            => loggerCore.WriteIfEnabled(LogLevel.Info, false, system, format, param1, param2, param3, param4);

        public void Info1(string system, string message)
            => loggerCore.WriteIfEnabled(LogLevel.Info, true, system, message);

        public void Info1<T1>(string system, string format, T1 param1)
            => loggerCore.WriteIfEnabled(LogLevel.Info, true, system, format, param1);

        public void Info1<T1, T2>(string system, string format, T1 param1, T2 param2)
            => loggerCore.WriteIfEnabled(LogLevel.Info, true, system, format, param1, param2);

        public void Info1<T1, T2, T3>(string system, string format, T1 param1, T2 param2, T3 param3)
            => loggerCore.WriteIfEnabled(LogLevel.Info, true, system, format, param1, param2, param3);

        public void Info1<T1, T2, T3, T4>(string system, string format, T1 param1, T2 param2, T3 param3, T4 param4)
            => loggerCore.WriteIfEnabled(LogLevel.Info, true, system, format, param1, param2, param3, param4);
        ...
        public void Warn(string system, string message)
            => loggerCore.WriteIfEnabled(LogLevel.Warn, false, system, message);

        public void Warn<T1>(string system, string format, T1 param1)
            => loggerCore.WriteIfEnabled(LogLevel.Warn, false, system, format, param1);

        public void Warn<T1, T2>(string system, string format, T1 param1, T2 param2)
            => loggerCore.WriteIfEnabled(LogLevel.Warn, false, system, format, param1, param2);

        public void Warn<T1, T2, T3>(string system, string format, T1 param1, T2 param2, T3 param3)
            => loggerCore.WriteIfEnabled(LogLevel.Warn, false, system, format, param1, param2, param3);

        public void Warn<T1, T2, T3, T4>(string system, string format, T1 param1, T2 param2, T3 param3, T4 param4)
            => loggerCore.WriteIfEnabled(LogLevel.Warn, false, system, format, param1, param2, param3, param4);

        public void Warn1(string system, string message)
            => loggerCore.WriteIfEnabled(LogLevel.Warn, true, system, message);

        public void Warn1<T1>(string system, string format, T1 param1)
            => loggerCore.WriteIfEnabled(LogLevel.Warn, true, system, format, param1);

        public void Warn1<T1, T2>(string system, string format, T1 param1, T2 param2)
            => loggerCore.WriteIfEnabled(LogLevel.Warn, true, system, format, param1, param2);

        public void Warn1<T1, T2, T3>(string system, string format, T1 param1, T2 param2, T3 param3)
            => loggerCore.WriteIfEnabled(LogLevel.Warn, true, system, format, param1, param2, param3);

        public void Warn1<T1, T2, T3, T4>(string system, string format, T1 param1, T2 param2, T3 param3, T4 param4)
            => loggerCore.WriteIfEnabled(LogLevel.Warn, true, system, format, param1, param2, param3, param4);
        ...
        public void Error(string system, string message)
            => loggerCore.WriteIfEnabled(LogLevel.Error, false, system, message);

        public void Error<T1>(string system, string format, T1 param1)
            => loggerCore.WriteIfEnabled(LogLevel.Error, false, system, format, param1);

        public void Error<T1, T2>(string system, string format, T1 param1, T2 param2)
            => loggerCore.WriteIfEnabled(LogLevel.Error, false, system, format, param1, param2);

        public void Error<T1, T2, T3>(string system, string format, T1 param1, T2 param2, T3 param3)
            => loggerCore.WriteIfEnabled(LogLevel.Error, false, system, format, param1, param2, param3);

        public void Error<T1, T2, T3, T4>(string system, string format, T1 param1, T2 param2, T3 param3, T4 param4)
            => loggerCore.WriteIfEnabled(LogLevel.Error, false, system, format, param1, param2, param3, param4);

        public void Error1(string system, string message)
            => loggerCore.WriteIfEnabled(LogLevel.Error, true, system, message);

        public void Error1<T1>(string system, string format, T1 param1)
            => loggerCore.WriteIfEnabled(LogLevel.Error, true, system, format, param1);

        public void Error1<T1, T2>(string system, string format, T1 param1, T2 param2)
            => loggerCore.WriteIfEnabled(LogLevel.Error, true, system, format, param1, param2);

        public void Error1<T1, T2, T3>(string system, string format, T1 param1, T2 param2, T3 param3)
            => loggerCore.WriteIfEnabled(LogLevel.Error, true, system, format, param1, param2, param3);

        public void Error1<T1, T2, T3, T4>(string system, string format, T1 param1, T2 param2, T3 param3, T4 param4)
            => loggerCore.WriteIfEnabled(LogLevel.Error, true, system, format, param1, param2, param3, param4);
